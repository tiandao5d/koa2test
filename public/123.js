    ...
    return c = {
      ...
      configure: function (e) {
        ...
        eachProp(e, function (e, t) {
          ...
          t = (e = "string" == typeof e ? {
            name: e
          } : e).name, e.location && (v.paths[t] = e.location), v.pkgs[t] = e.name + "/" + (e.main || "main").replace(currDirRegExp, "").replace(jsSuffixRegExp, "")
      ...
      makeRequire: function (o, a) {
        function s(e, t, n) {
          ...
          return a.enableBuildCallback && t && isFunction(t) && (t.__requireJsBuild = !0), "string" == typeof e ? isFunction(t) ? j(makeError("requireargs", "Invalid require call"), n) : o && hasProp(c, e) ? c[e](d[o.id]) : req.get ? req.get(p, e, o, s) : (i = E(e, o, !1, !0).id, hasProp(m, i) ? m[i] : j(makeError("notloaded", 'Module name "' + i + '" has not been loaded yet for context: ' + l + (o ? "" : ". Use require([])")))) : (A(), p.nextTick(function () {
            A(), (r = k(E(null, o))).skipMap = a.skipMap, r.init(e, t, n, {
              enabled: !0
            }), N()
          }), s)
        }
...
var FOP = {},
  ...
  wgtlib = "wgt/coreLibs/";
require.config({
  baseUrl: window.isStaticedDemo ? "../../public/" : window.globalObj.getProtocol() + getStaticHost() + "/public/",
  waitSeconds: 8e3,
  shim: {
    bMap: {
      exports: "bMap"
...
var readyFun = function () {
  ...
  var e = window.location.hostname;
  sendLevel.test(e) || isStaticedDemo || (injectScript(document, [window.globalObj.getProtocol() + getStaticHost() + "/employcode.js?v=" + (new Date).getTime()], function () {}), "true" != isxinnet && injectScript(document, [gatherScripts], function () {
    try {
    ...
    function F(e, t, n, i) {
      if (T.acceptData(e)) {
        var r, o, a = T.expando,
          ...
          l = s ? T.cache : e,
          c = s ? e[a] : e[a] && a;
        if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof t) return c || (c = s ? e[a] = d.pop() || T.guid++ : a), l[c] || (l[c] = s ? {} : {
          toJSON: T.noop
        }), "object" != typeof t && "function" != typeof t || (i ? l[c] = T.extend(l[c], t) : l[c].data = T.extend(l[c].data, t)), o = l[c], i || (o.data || (o.data = {}), o = o.data), void 0 !== n && (o[T.camelCase(t)] = n), "string" == typeof t ? null == (r = o[t]) && (r = o[T.camelCase(t)]) : r = o, r
      }
    }
